...
header('location:index.php');
		...
		if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"update shipbill set billingAddress='$baddress',billingState='$bstate',billingCity='$bcity',billingPincode='$bpincode' where id='".$_SESSION['id']."'");
		if($query)
		{
echo "<script>alert('Billing Address has been updated');</script>";
	...
	if(isset($_POST['shipupdate']))
	{
		...
		$query=mysqli_query($con,"update shipbill set shippingAddress='$saddress',shippingState='$sstate',shippingCity='$scity',shippingPincode='$spincode' where id='".$_SESSION['id']."'");
		if($query)
		{
