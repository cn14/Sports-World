...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($con,"update  productimg set productImage2='$productimage2' where id='$pid' ");
...
$query=mysqli_query($con,"select productName,productImage2 from products natural join productimg where id='$pid'");
$cnt=1;
