...
<?php include('include/header.php');?>
	...
	<div class="wrapper" style="background:  #f4ecf7 ">
		<div class="container">
			<div class="row">
...
?>									
										...
										<tr>
											...
											<a href="deletepro.php?id=<?php echo $row['id'];?>" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
