...
if(isset($_POST['submit']))
{
	...
	$sql=mysqli_query($con,"update  productimg set productImage3='$productimage3' where id='$pid' ");
...
$query=mysqli_query($con,"select productName,productImage3 from products  natural join productimg where id='$pid'");
$cnt=1;
