...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($con,"update  productimg set productImage1='$productimage1' where id='$pid' ");
...
$query=mysqli_query($con,"select productName,productImage1 from products natural join productimg where id='$pid'");
$cnt=1;
